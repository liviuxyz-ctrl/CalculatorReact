...
export default function App()
{
    ...
    const Btn = ({symbol, color}) => {
        return (
            <TouchableOpacity onPress={() => updateCalc(symbol)} style={{backgroundColor: '#243441', width: 60, height: 60, margin: 10, shadowColor: "#000", borderRadius: 10, shadowOffset: {width: 0,height: 2,},shadowOpacity: 0.25,shadowRadius: 3.84,elevation: 5,}}>
                <Text style={{color: color, fontSize: 20, textAlign: 'center', marginTop: 15, fontWeight: 'bold'}}>{symbol}</Text>
            </TouchableOpacity>
        )
    }
